...
const DEFAULT_ORDER = ['builtin', 'external', 'internal', 'parent', 'sibling', 'index'];

(0, _ava2.default)('sanitizeOrder should leave default order unchanged', t => {
  t.deepEqual((0, _compareImports.sanitizeOrder)(DEFAULT_ORDER), DEFAULT_ORDER);
});

(0, _ava2.default)('sanitizeOrder should append all omitted groups', t => {
  t.deepEqual((0, _compareImports.sanitizeOrder)(['external']), ['external', ['builtin', 'internal', 'parent', 'sibling', 'index'].sort()]);
  t.deepEqual((0, _compareImports.sanitizeOrder)(['builtin', ['internal', 'parent', 'sibling', 'index']]), ['builtin', ['internal', 'parent', 'sibling', 'index'].sort(), 'external']);
});
