...
describe("Option change detect", function () {
  function options(oldOptions, newOptions) {
    var _diffOptions = diffOptions(oldOptions, newOptions),
  ...
  it("could detect remove and add package", function () {
    ...
    }).removePackages("b").notRemovePackages("a").addPackages("c").notAddPackages("a");
  });

  fit("could detect change package", function () {
    options({
      packages: {
        a: {
          main: "X"
